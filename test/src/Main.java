...
public class Main {
    public static void main(String args[]){
        ...
        try{
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/library?autoReconnect=true&useSSL=false", "debian-sys-maint", "lYKZkZJIcKPGaH9m");

            System.out.println("---------------Welocome To IIITA Library!-----------------");
            while(true) {
                ...
                if (userType == 1) {
                    ...
                    System.out.println("1. Add the Book Info\n2. Delete the Book Info\n3. Edit the Book Info\n4. Issue The Book\n5. Return The Book");
                    ...
                    if (operationType == 1) {
                        ...
                        if (updateType == 1) {
                            ...
                            System.out.println("-----------Please Enter the Book Id and Book name-----------------");
                            System.out.println("Enter the Book Id:");
                            String as = input.nextLine();
                            String BookId = input.nextLine();
                            System.out.println("Enter the Book name:");
            ...
            System.out.println("Thank You! For Using IIITA Library");
        }
    }
}
